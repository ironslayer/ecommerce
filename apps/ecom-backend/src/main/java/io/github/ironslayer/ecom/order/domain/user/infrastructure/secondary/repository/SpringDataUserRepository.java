package io.github.ironslayer.ecom.order.domain.user.infrastructure.secondary.repository;


import io.github.ironslayer.ecom.order.domain.user.aggregate.User;
import io.github.ironslayer.ecom.order.domain.user.infrastructure.secondary.entity.UserEntity;
